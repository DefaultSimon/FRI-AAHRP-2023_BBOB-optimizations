...
pub fn get_optimal_params(
    ...
    run_sa(problem, current_options).unwrap();
    ...
    let value_change = value_changes[0];
    match value_change.option {
        InitialTemperature => match value_change.direction {
            Direction::Positive => {
                new_options = SAOptions {
                    initial_temperature: current_options.initial_temperature + 2,
                    ..new_options
                }
            }
            Direction::Negative => {
        ...
        AnnealingSchedule => match value_change.direction {
            Direction::Positive => {
                new_options = SAOptions {
        ...
        MaxIterationsSa => match value_change.direction {
            Direction::Positive => {
                new_options = SAOptions {
                    max_iterations_sa: current_options.max_iterations_sa + 500,
                    ..new_options
                }
            }
            Direction::Negative => {
        ...
        MaxIterationsLs => match value_change.direction {
            Direction::Positive => {
                new_options = SAOptions {
                    max_iterations_ls: current_options.max_iterations_ls + 1000,
                    ..new_options
                }
            }
            Direction::Negative => {
        ...
        InitialStepSizeSa => match value_change.direction {
            Direction::Positive => {
                new_options = SAOptions {
                    initial_step_size_sa: current_options.initial_step_size_sa
                        + 0.1,
                    ..new_options
                }
            }
        ...
        InitialStepSizeLs => match value_change.direction {
            Direction::Positive => {
                new_options = SAOptions {
                    initial_step_size_ls: current_options.initial_step_size_ls
                        + 0.01,
                    ..new_options
                }
            }
        ...
        MinTemp => match value_change.direction {
            Direction::Positive => {
                new_options = SAOptions {
        ...
        BestNSa => match value_change.direction {
            Direction::Positive => {
        ...
        BestNLs => match value_change.direction {
            Direction::Positive => {
